...
contract OldPotatos is ERC721, Ownable,Pausable {
    ...
    constructor(string memory _baseURII) ERC721("Bored Potato Club", "BPC"){tokenBaseURI=_baseURII; Owner = payable(msg.sender);}
